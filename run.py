...
def run(*argv):
    ...
    parser.add_argument('--batchnorm', action='store_true',
                        help='Use bathnorm')
    parser.add_argument('--decode_mode', type=str, choices=['max', 'sample', 'gumbel', 'samplek', 'beam'],
                        default='beam',
    ...
    args.name = cargs.name or time.strftime(
        "run%Y%m%d_%H%M%S", time.localtime())
